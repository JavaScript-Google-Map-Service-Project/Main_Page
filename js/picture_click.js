...
function initMap() {
  ...
  var busan = new clickZoom(busanPicture, map, 'images/example.jpg',
                            35.115, 129.045, 640);
  var daegu = new clickZoom(daeguPicture, map, 'images/example.jpg',
                            35.783, 128.563, 640);
  var seoul = new clickZoom(seoulPicture, map, 'images/example.jpg',
                            37.505, 126.993, 640);
  var incheon = new clickZoom(incheonPicture, map, 'images/example.jpg',
                            37.41, 126.705, 640);
  var jeju = new clickZoom(jejuPicture, map, 'images/example.jpg',
                            33.453, 126.533, 640);
  var daejeon = new clickZoom(daejeonPicture, map, 'images/example.jpg',
                            36.295, 127.395, 640);
  var ulsan = new clickZoom(ulsanPicture, map, 'images/example.jpg',
                            35.5, 129.256, 640);
  var gwangju = new clickZoom(gwangjuPicture, map, 'images/example.jpg',
                            35.11, 126.837, 640);
